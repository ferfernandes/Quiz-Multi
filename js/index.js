...
const scenes = [
    {
        title: 'Mais produtividade e usos mais corriqueiros que não exija tanto desempenho e precisão',
        name: 'akuaku', // Must mirror class name
        author: 'Qualidade', // Your name
        codepenprofile: 'jotavejv', // Your Codepen profile link
        answer: 'Periféricos Tradicionais', // The correct game, we can obfuscate this later if we want to hide answers
        backgroundColor: '#4E216C', // Page background color for your scene
        
    },{
        title: 'Dispositivo utilizado para o gerenciamento veloz de dados e informações de um computador',
        name: 'kirby', // Must mirror class name
        author: 'Qualidade', // Your name
        codepenprofile: 'kathykato', // Your Codepen profile link
        answer: 'Memória RAM', // The correct game, we can obfuscate this later if we want to hide answers
        backgroundColor: '#F26729', // Page background color for your scene
        hint: 'A Nintendo classic'
    }, {
        title: 'Tátil e possui som ao pressionar as teclas',
        name: 'hexipal', // Must mirror class name
        author: 'Qualidade', // Your name
        codepenprofile: 'KristopherVanSant', // Your Codepen profile link
        answer: 'Switch Blue', // The correct game, we can obfuscate this later if we want to hide answers
        backgroundColor: '#80c342', // Page background color for your scene
        hint: 'An animated puzzle adventure'
    }, {
        title: 'Tecnologia de armazenamendo de dados considerada a evolução do HD',
        name: 'moogle', // Must mirror class name
        author: 'Qualidade', // Your name
        codepenprofile: 'jnwright', // Your Codepen profile link
        answer: 'SSD', // The correct game, we can obfuscate this later if we want to hide answers
        backgroundColor: '#00B5DE', // Page background color for your scene
        hint: 'Kupo!'
    }, {
        title: 'Possui 7 canais de áudio, dando a sensação de imersão para quem utiliza o Headset',
        ...
        answer: 'Áudio 7.1', // The correct game, we can obfuscate this later if we want to hide answers
        ...
        author: 'Qualidade', // Your name
        codepenprofile: '', // Your Codepen profile link
        answer: '', // The correct game, we can obfuscate this later if we want to hide answers
...
function initScene(scene) {
    ...
    $('.main_inner__title h1').text(scenes[progress -1].title);
...
$(answer).click(function() {
    ...
    if(!transitioning) {
        ...
        if(checkAnswer($(this))) {
            ...
            $('.main_inner__feedback').text('CORRETO').addClass('correct');
            ...
            $('.main_inner__feedback').text('ERRADO').addClass('wrong');
            $('.main_inner__feedback').css('transform', 'translateY(-50%) scale(1) rotate(0deg)');
        }
        ...
        if(progress == $('.scene').length + 1) {
            ...
            $('p.score').html('Você acertou ' + $('.breadcrumb.correct').length + ' de 5 corretas!')
        }
